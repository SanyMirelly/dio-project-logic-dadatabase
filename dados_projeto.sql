...
-- idOrder, idOrderClient, orderStatus, orderDescription, Freigth, PaymentCash

delete from Orders where idOrderClient in  (1,2,3,4);
insert into Orders (idOrderClient, orderStatus, orderDescription, Freight, PaymentCash) values 
